  ...
  `.execute(db);
    ...
    await db.schema
        ...
        .$call((qb) =>
            PARTITIONS
                ? qb
                      .addPrimaryKeyConstraint("chain_events_pkey", [
                          "id",
                          "fid",
                      ])
                      .addUniqueConstraint(
                ...
                : qb
                      ...
                      .addUniqueConstraint(
                          "chain_events_block_number_log_index_unique",
        ...
        .$call((qb) =>
            PARTITIONS
                ? qb
                      ...
                      .addUniqueConstraint("messages_hash_unique", [
                          "fid",
                          "hash",
                      ])
                      .modifyEnd(sql`PARTITION BY HASH (fid)`)
        ...
        .$call((qb) =>
            PARTITIONS
                ? qb
                      ...
                      .addUniqueConstraint("casts_hash_fid_unique", [
                          "hash",
                          "fid",
                      ])
                      .addForeignKeyConstraint(
        ...
        .$call((qb) =>
            PARTITIONS
                ? qb
                      ...
                      .addUniqueConstraint("reactions_hash_fid_unique", [
                          "hash",
                          "fid",
                      ])
                      .addForeignKeyConstraint(
        ...
        .$call((qb) =>
            PARTITIONS
                ? qb
                      ...
                      .addUniqueConstraint("links_fid_hash_unique", [
                          "hash",
                          "fid",
                      ])
                      .modifyEnd(sql`PARTITION BY HASH (fid)`)
    ...
    await db.schema
        ...
        .$call((qb) =>
            PARTITIONS
                ? qb
                      .addPrimaryKeyConstraint("verifications_pkey", [
                          "id",
                          "fid",
                      ])
                      .addForeignKeyConstraint(
        ...
        .$call((qb) =>
            PARTITIONS
                ? qb
                      ...
                      .addUniqueConstraint("user_data_fid_hash_unique", [
                          "fid",
                          "hash",
                      ])
                      .addForeignKeyConstraint(
    ...
    await db.schema
        ...
        .$call((qb) =>
            PARTITIONS
                ? qb
                      .addPrimaryKeyConstraint("storage_allocations_pkey", [
                          "id",
                          "fid",
                      ])
                      .modifyEnd(sql`PARTITION BY HASH (fid)`)
